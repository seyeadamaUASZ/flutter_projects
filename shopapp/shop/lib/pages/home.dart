            ...
            Expanded(child:
             Obx((){
               ...
               if(productsController.products.isEmpty){
                 return Center(child: Text("Pas de produits disponibles..."));
               }
               if(productsController.showGrid.value==true){
                        ...
                        Container(  
                          ...
                          decoration: BoxDecoration(  
                            image: DecorationImage(  
                              ...
                              image: NetworkImage(productsController.products[index]['image'],                 
                              ),
                              fit: BoxFit.fill,
                        ...
                        Expanded(
                          child: Column(  
                            ...
                            children: [
                              ...
                              Expanded(child: Text(productsController.products[index]['description'],
                                maxLines: 2,
                                overflow: TextOverflow.ellipsis,
                              )),
                 ...
                 Expanded(
                   child: Container(   
                     ...
                     child: Row(  
                       ...
                       children: [
                         Text('Vêtements',style: TextStyle(  
                           fontWeight: FontWeight.bold
                         ),),
